...
class BotConfig:
    ...
    # group
    talk_allowed_groups = BlacklistSet()
    ...
    def load_config(cls, config_path: str = None) -> "BotConfig":
        ...
        def quail(parent: dict):
            quail_config = parent["quail"]
            config.QUAIL_COEFFICIENT_MAP = dict(quail_config.get("quail_coefficient_map", config.QUAIL_COEFFICIENT_MAP))
            # 检查是否为字典格式
        ...
        def groups(parent: dict):
            ...
            config.talk_allowed_groups = BlacklistSet(groups_config.get("talk_allowed", []))
